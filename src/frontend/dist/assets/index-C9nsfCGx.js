...
const GameLoader = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "div",
  {
    ...
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full border-4 border-t-transparent border-primary animate-spin" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-display font-bold text-sm tracking-widest uppercase opacity-60", children: "Loading…" })
    ] })
  }
);
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(GameLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
});
